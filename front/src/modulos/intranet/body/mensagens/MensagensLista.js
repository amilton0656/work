    ...
    return (
        <div>
                ...
                texto={
                    <div>
                        ...
                        <div className="card-text" style={{ fontSize: '1.1em' }}>
                            <div >
                                <div >Em função do horário do jogo da Seleção Brasileira, nesta segunda-feira, dia 29/JUN/2026, encerraremos o expediente às 11:30.
            ...
            <MensagemNiver
                ...
                nome="SUELI"
                local="(RH)"
                dataExt="05/fevereiro - Quinta-feira"
            />
            ...
            <MensagemText
                ...
                texto={<p className="card-text" style={{ fontSize: '1.1em' }}>
                    <br />
                    <span className='intra-card__texto-nome'>Fernanda</span>,  comemorando seu aniversário, convida a
                    todos para aquele tradicional
                    <span className='intra-card__texto-bolo'> bolinho</span>, hoje, às 16:00, no 11º andar (recepção).
                </p>} />
            ...
            <MensagemNiver
                ...
                nome="FERNANDA"
                local="(Comercial)"
                dataExt="04/fevereiro - Quarta-feira"
            />
                    ...
                    <div className="card-text" style={{ fontSize: '1.5rem', color: 'blue' }}>
                        ...
                        <div style={{ display: 'flex', marginLeft: 40 }}>
                            <div style={{ marginTop: '20px', fontSize: '1.5rem', flex: 1 }}>
                                <div style={{ width: '400px' }}><span style={{ color: "#403d43", fontSize: '1.3rem' }}>Dia 13/02/2026</span></div>
                        ...
                        <div style={{ display: 'flex', marginLeft: 40 }}>
                            <div style={{ marginTop: '20px', fontSize: '1.5rem', flex: 1 }}>
                                <div style={{ width: '400px' }}><span style={{ color: "#403d43", fontSize: '1.3rem' }}>Dia 18/02/2026</span></div>
            ...
            <MensagemNiver2
                ...
                local2="(Copa)"
                dataExt="24/setembro - Quarta-feira"
            />
            ...
            <MensagemNiver
                ...
                nome="LIDIA"
                local="(Engenharia)"
                dataExt="15/setembro - Segunda-feira"
            />
            ...
            <MensagemNiver
                ...
                nome="STEFFANY"
                local="(Marketing)"
                dataExt="03/Setembro - Quarta-feira"
            />
                    ...
                    <div className="card-text" style={{ fontSize: '1.5rem' }}>
                        ...
                        <div style={{ display: 'flex', marginLeft: 40 }}>
                            <div style={{ marginTop: '20px', fontSize: '1.2rem', flex: 1 }}>
                                <div style={{ display: 'flex' }}>
                                    <div style={{ width: '150px' }}><span style={{ color: 'blue', fontSize: '1.3rem' }}>Encerramento</span></div>
                                    <div><span style={{ marginLeft: 30, fontSize: '1.3rem' }}>Dia 18/JUN/2025, quarta-feira, às 18:00 </span></div>
                                </div>
                                <div style={{ display: 'flex' }}>
                                    <div style={{ width: '150px' }}><span style={{ color: 'blue', fontSize: '1.3rem' }}>Retorno</span></div>
                                    <div><span style={{ marginLeft: 30, fontSize: '1.3rem' }}>Dia 23/JUN/2025, segunda-feira, às 08:00 </span></div>
                                </div>
