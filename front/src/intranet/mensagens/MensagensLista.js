    ...
    return (
        <div>
            ...
            <MensagemText
                ...
                texto={<p class="card-text" style={{ fontSize: '1.1em' }}>
                    <br />
                    <span style={{ color: 'blue' }}>Paulão</span>,  comemorando antecipadamente seu aniversário, convida a
                    todos para aquele tradicional
                    <span style={{ color: 'green' }}>
                        <strong>
                            <em> bolinho</em>
                        </strong>
                    </span>, hoje, às 16:30, no 11º andar (recepção).
                </p>} />
                ...
                texto={
                    <p class="card-text" style={{ fontSize: '1.5rem' }}>
                        ...
                        <div style={{ marginTop: '20px', fontSize: '1.2rem', display: 'flex', justifyContent: 'start', alignItems: 'center' }}>
                            <div style={{ width: '200px' }}><span style={{ color: 'blue' }}>Admininistração e <br /> Assistência Técnica : </span></div>
            ...
            <MensagemText
                ...
                texto={<p class="card-text" style={{ fontSize: '1.1em' }}>
                    <br />
                    <span style={{ color: 'blue' }}>Eugênio e Cida</span>, antecipando a comemoração dos seus aniversários, convidam a
                    todos para aquele tradicional
                    <span style={{ color: 'green' }}>
                        <strong>
                            <em> bolinho</em>
            ...
            <MensagemText
                ...
                texto={<p class="card-text" style={{ fontSize: '1.1em' }}>
                    <br />
                    <span style={{ color: 'blue' }}>Lidia</span>, comemorando seu aniversário, convida a
                    todos para aquele tradicional
                    <span style={{ color: 'green' }}>
                        <strong>
                            <em> bolinho</em>
            ...
            <MensagemText
                ...
                texto={<p class="card-text" style={{ fontSize: '1.1em' }}>
                    <br />
                    <span style={{ color: 'blue' }}>Antônio</span>,  comemorando seu aniversário, convida a
                    todos para aquele tradicional
                    <span style={{ color: 'green' }}>
                        <strong>
                            <em> bolinho</em>
            ...
            <MensagemText
                ...
                texto={<p class="card-text" style={{ fontSize: '1.1em' }}>
                    <br />
                    <span style={{ color: 'blue' }}>Liliane</span>,  comemorando seu aniversário, convida a
                    todos para aquele tradicional
                    <span style={{ color: 'green' }}>
                        <strong>
                            <em> bolinho</em>
            ...
            <MensagemText
                ...
                texto={<p class="card-text" style={{ fontSize: '1.1em' }}>
                    <br />
                    <span style={{ color: 'blue' }}>Heliane</span>, comemorando seu aniversário, convida a
                    todos para aquele tradicional
                    <span style={{ color: 'green' }}>
                        <strong>
                            <em> bolinho</em>
            ...
            <MensagemText
                ...
                texto={<p class="card-text" style={{ fontSize: '1.1em' }}>
                    <br />
                    <span style={{ color: 'blue' }}>Marco</span>, comemorando antecipadamente seu aniversário, convida a
                    todos para aquele tradicional
                    <span style={{ color: 'green' }}>
                        <strong>
                            <em> bolinho</em>
                        </strong>
                    </span>, hoje, às 15:00, no 11º andar (recepção).
                </p>} />
            ...
            <MensagemText
                ...
                texto={<p class="card-text" style={{ fontSize: '1.1em' }}>
                    ...
                    </span>, hoje, às 15:30, no 11º andar (recepção).
                </p>} />
                ...
                texto={
                    <p class="card-text" style={{ fontSize: '1.5rem' }}>
                        ...
                        <div style={{ marginTop: '20px', fontSize: '1.2rem', display: 'flex', justifyContent: 'start' }}>
                            <div style={{ width: '200px' }}><span style={{ color: 'blue' }}>Admin/Obras (Bliss) : </span></div>
                            <div><span>Dia 12/FEV/2021, sexta-feira, no horário normal </span></div>
                        </div>

                        <div style={{ fontSize: '1.2rem', display: 'flex', justifyContent: 'start' }}>
                            <div style={{ width: '200px' }}><span style={{ color: 'green' }}>Assistência Técnica : </span></div>
                            <div><span>Dia 12/FEV/2021, sexta-feira, no horário normal </span></div>
                        </div>
                        <div style={{ marginTop: '30px' }}>
                            <span style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>Retorno:</span>
            ...
            <MensagemText
                ...
                texto={<p class="card-text" style={{ fontSize: '1.1em' }}>
                    <br />
                    <span style={{ color: 'blue' }}>Luize</span>,  comemorando seu aniversário, convida a
                    todos para aquele tradicional
                    <span style={{ color: 'green' }}>
                        <strong>
                            <em> bolinho</em>
            ...
            <MensagemText
                ...
                texto={<p class="card-text" style={{ fontSize: '1.1em' }}>
                    <br />
                    <span style={{ color: 'blue' }}>Paulão</span>,  comemorando seu aniversário, convida a
                    todos para aquele tradicional
                    <span style={{ color: 'green' }}>
                        <strong>
                            <em> bolinho</em>
            ...
            <MensagemText
                ...
                texto={<p class="card-text" style={{ fontSize: '1.1em' }}>
                    <br />
                    <span style={{ color: 'blue' }}>Cinira</span>, comemorando antecipadamente seu aniversário, convida a
                    todos para aquele tradicional
                    <span style={{ color: 'green' }}>
                        <strong>
                            <em> bolinho</em>
